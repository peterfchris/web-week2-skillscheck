...
// and love which will be a string of something you love. Have the function take the two parameters and rerun a string that says 
...
// firstName will be your name as a string. state will be your current state or providence as a string. 
// age will be your age as a number. greeter will be a method that returns the string 'Hello! My name is NAMEVALUE and I live in STATEVALUE' with the correct values
...
// If the number is GREATER than 100, push 'big' as a string to the answers array. If the number is LESS than or EQUAL to 100, push 'small' as a string to the answers array. 
...
// Create a function called 'arrayReverser' that takes in one parameter, arr. Inside of arrayReverser, 
// create an empty array called 'reversed'. Using a for loop, loop over the passed in array in reverse and add each 
// item to the new reversed array. Finally, return the new reversed array
...
// Code Here
const totallyAwesome = people.reduce((function(total, element) {return total + element.awesomeLevel}), 0)